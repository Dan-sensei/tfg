...
function getRandomBaseDocument(categoryLength: number, titulationLength: number): BaseDocument {
    return {
        collegeId: 1,
...
async function postSeed() {
    ...
    const tfgsData = [
        ...
        },
        {
            ...
            tags: ["Energía Renovable", "Cambio Climático", "Ciencia Ambiental"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            tags: ["Inteligencia Artificial", "Educación", "Tecnología Educativa"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            tags: ["Inteligencia Artificial", "Industria Automotriz", "Tecnología"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            tags: ["Inteligencia Artificial", "Agricultura", "Tecnología Agrícola"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            tags: ["Psicología del Aprendizaje", "Educación en Línea", "Tecnología Educativa"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            tags: ["Inteligencia Artificial", "Industria Alimentaria", "Tecnología"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            tags: ["Inteligencia Artificial", "Educación Superior", "Tecnología Educativa"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            tags: ["Inteligencia Artificial", "Ética Empresarial", "Tecnología"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            tags: ["Inteligencia Artificial", "Automatización Industrial", "Tecnología"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            author: "Ana Pérez",
            tutor: "Prof. Javier Rodríguez",
            tags: ["Inteligencia Artificial", "Educación Primaria", "Tecnología Educativa"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            tags: ["Psicología del Consumidor", "Comportamiento de Compra", "Marketing"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            tutor: "Dr. Juan García",
            tags: ["Astronomía", "Telescopios Espaciales", "Exploración Espacial"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            author: "Carlos Pérez",
            tutor: "Dra. Laura García",
            tags: ["Inteligencia Artificial", "Fraude Financiero", "Tecnología Financiera"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            author: "Isabel García",
            tutor: "Dr. Pedro Sánchez",
            tags: ["Ingeniería Genética", "Enfermedades Hereditarias", "Medicina"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            author: "Marta Rodríguez",
            tutor: "Dra. Carmen Pérez",
            tags: ["Psicología del Consumidor", "Comportamiento en Línea", "Marketing"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            author: "Diego Martínez",
            tutor: "Dra. María García",
            tags: ["Neurociencia del Sueño", "Trastornos del Sueño", "Psicología"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
            ...
            author: "Isabel López",
            tutor: "Prof. Juan Pérez",
            tags: ["Inteligencia Artificial", "Agricultura de Precisión", "Tecnología Agrícola"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            author: "Carlos Pérez",
            tutor: "Dra. Laura García",
            tags: ["Inteligencia Artificial", "Cadena de Suministro", "Logística"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            author: "Daniel García",
            tutor: "Dra. Laura Rodríguez",
            tags: ["Inteligencia Artificial", "Cambio Climático", "Medio Ambiente"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            author: "Javier López",
            tutor: "Prof. Laura Rodríguez",
            tags: ["Fondos Marinos Profundos", "Exploración Submarina", "Biología Marina"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
            ...
            author: "Elena Sánchez",
            tutor: "Dr. Juan Martín",
            tags: ["Inteligencia Artificial", "Industria Automotriz", "Automatización"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
            title: "La Ética en la Investigación Científica",
        ...
        },
        {
            ...
            author: "Francisco López",
            tutor: "Dra. María Rodríguez",
            tags: ["Biología Sintética", "Organismos Modificados Genéticamente", "Tecnología"],
        },
        {
            ...getRandomBaseDocument(Category.length, GradeMaster.length),
        ...
        },
        {
            ...
            author: "Ana Rodríguez",
            tutor: "Dr. Carlos López",
            tags: ["Inteligencia Artificial", "Industria Aeroespacial", "Automatización"],
        },
    ];
...
*/
    ...
    const authors = tfgsData.map((tfg, index) => {
        return {
            name: tfg.author,
            image: null,
            email: `e${index}@gmail.com`,
            role: Role.STUDENT,
    ...
    //const connect = allStudents.map((a, index) => ({ tfgId: index + 1, userId: a.id, assignedBy: "D" }));
    //await prisma.userTFG.createMany({ data: connect });
...
async function populateTutors() {
    ...
    for (const tfg of tfgsWithoutTutors) {
        const assignedTutors = new Set<number>();
        ...
        for (let i = 0; i < numberOfTutors; i++) {
            ...
            assignedTutors.add(tutors[randomIndex].id);
        }

        // Update the TFG record with the selected tutor(s)
        for (const tutorId of Array.from(assignedTutors)) {
            await prisma.tfg.update({
                where: { id: tfg.id },
                data: {
                    users: {
